...
public class Utils {
    ...
    public String getNomPackage()         { return nomPackage; }
    public String getNiveau()             { return niveau; }
    public String getAnnotationCherche()  { return annotationCherche; }

    public void setNomPackage(String nomPackage)               { this.nomPackage = nomPackage; }
    public void setNiveau(String niveau)                       { this.niveau = niveau; }
    public void setAnnotationCherche(String annotationCherche) { this.annotationCherche = annotationCherche; }
 ...
 public List<Class<?>> getClasses() throws Exception {
    ...
    //     try {
    //         List<Class<?>> classes = getClasses(); // ✔ utilise this.nomPackage en interne
